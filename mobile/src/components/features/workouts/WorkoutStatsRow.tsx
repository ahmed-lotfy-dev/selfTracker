  ...
  return (
    ...
    >
      <StatCard
        ...
        icon={<FontAwesome5 name="dumbbell" size={12} color="white" />}
      ...
      <StatCard
        ...
        icon={<MaterialIcons name="calendar-today" size={14} color="white" />}
      ...
      <StatCard
        ...
        icon={<MaterialIcons name="fitness-center" size={14} color="white" />}
