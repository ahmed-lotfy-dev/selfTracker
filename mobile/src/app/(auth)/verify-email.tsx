...
export default function VerifyEmail() {
  ...
  const handleResendCode = async () => {
    try {
      await resendVerificationEmail(user?.email || "", otp)
  ...
  return (
    ...
    >
      <Text className="font-bold text-xl mb-4 text-center">Verify Your Email</Text>
      ...
      {isLoading && <Text className="mt-4">Checking verification status...</Text>}
