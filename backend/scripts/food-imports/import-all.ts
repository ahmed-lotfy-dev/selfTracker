 ...
 * Uses Drizzle db.execute with parameterized queries
 */
      ...
      try {
        await db.execute(sql`
          INSERT INTO foods (
            ...
            ${n.calcium_100g || null},
            ${n.iron_100g || null},
            ${n.magnesium_100g || null},
            ${n.phosphorus_100g || null},
            ${n.zinc_100g || null},
            ${n.copper_100g || null},
            ${n.manganese_100g || null},
            ${n.selenium_100g || null},
            ${n.vitamin_a_100g || null},
            ${n.vitamin_d_100g || null},
            ${n.vitamin_e_100g || null},
            ${n.vitamin_c_100g || null},
            ${n.vitamin_b1_100g || null},
            ${n.vitamin_b2_100g || null},
            ${n.vitamin_b6_100g || null},
            ${n.vitamin_b9_100g || null},
            ${n.vitamin_b12_100g || null},
            ${n.trans_fat_100g || null},
            ${n.added_sugars_100g || null},
            ${n.starch_100g || null},
        ...
        errors++
        if (errors <= 3) console.error(`[${source}] ERROR: ${err.message?.slice(0, 200)}`)
      }
    }
      ...
      try {
        await db.execute(sql`
          INSERT INTO branded_foods (
            ...
            ${f.brand_name || null},
            ${f.gtin_upc || null},
            ${f.branded_food_category || null},
            ${parseFloat(f.serving_size) || null},
        ...
        errors++
        if (errors <= 3) console.error(`[usda_branded] ERROR: ${err.message?.slice(0, 200)}`)
      }
    }
